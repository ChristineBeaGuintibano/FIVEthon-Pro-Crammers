...
class StopWatch(Frame):  
    ...
    def makeWidgets(self):                          
        ...
        l2.pack(fill=X, expand=NO, pady=1, padx=2, side= TOP)

        self.e = Entry(self)
        self.e.pack(pady=2, padx=2)
        
        l = Label(self, textvariable=self.timestr, font= ("Helvetica", 20), borderwidth=4, relief="groove")
        self._setTime(self._elapsedtime)
        l.pack(fill=X, expand=NO, pady=3, padx=2)

        l3 = Label(self, text='Laps:', font = 'Helvetica')
        l3.pack(fill=X, expand=NO, pady=4, padx=2)
